...
expDes.gabor_orient_degS = (randi([0, 4294967295] ,...
    [const.nb_trials,2, const.gabor_count]) ./ 4294967296).*180;
expDes.gabor_phase_lst = (randi([0, 4294967295], ...
    [const.nb_trials,2, const.gabor_count]) ./ 4294967296).*360;
...
for tt = 1:const.nb_trials
    ...
    % stimuli for the two intervals
    for intrvl = 1:2
        
        % local speed value for each Gabor
        nb_signal = 0;
